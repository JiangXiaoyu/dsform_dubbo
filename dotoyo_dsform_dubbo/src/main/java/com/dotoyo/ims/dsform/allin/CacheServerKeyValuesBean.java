...
public class CacheServerKeyValuesBean {
	protected static final transient IFrameLog log = new LogProxy(
			LogFactory.getLog(CacheServerKeyValuesBean.class));

	protected Map<String, Map<String, String>> paramMap = new HashMap<String, Map<String, String>>();

	protected static CacheServerKeyValuesBean instance = null;

	protected CacheServerKeyValuesBean() {
		String xmlPath = "";
		InputStream is = null;
		try {
	...
	public static CacheServerKeyValuesBean getInstance() {
		if (instance == null) {
			newInstance();
		}
		return instance;
	...
	synchronized private static void newInstance() {
		if (instance == null) {
			instance = new CacheServerKeyValuesBean();
		}
	}
