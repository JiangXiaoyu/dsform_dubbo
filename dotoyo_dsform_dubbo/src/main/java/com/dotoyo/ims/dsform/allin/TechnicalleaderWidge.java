 ...
 *
 */
public class TechnicalleaderWidge implements IWidgeType {

	public static final String WIDGE_NAME = "technicalleader".toLowerCase();

	private IWidgeType widge = null;

	public TechnicalleaderWidge(IWidgeType widge) {
		this.widge = widge;
	}
