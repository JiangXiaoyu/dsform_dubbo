...
public class AnnexKeyValuesConfig {
	protected static final transient IFrameLog log = new LogProxy(
			LogFactory.getLog(AnnexKeyValuesConfig.class));

	protected Map<String, Map<String, String>> paramMap = new HashMap<String, Map<String, String>>();

	protected static AnnexKeyValuesConfig instance = null;

	protected AnnexKeyValuesConfig() throws Exception {
		String xmlPath = "";
		InputStream is = null;
		try {
	...
	public static AnnexKeyValuesConfig getInstance() throws Exception {
		if (instance == null) {
			newInstance();
		}
		return instance;
	...
	synchronized private static void newInstance() throws Exception {
		if (instance == null) {
			instance = new AnnexKeyValuesConfig();
		}
	}
	...
	public static void main(String[] args) throws Exception {
		Map<String, Map<String, String>> map=	AnnexKeyValuesConfig.getInstance().getKeyValues();
		log.debug(map);
	}
