...
/*
 * Accumulated offset 沉降位移累计偏移
 */
public class DsplAccumOfsWidge implements IWidgeType {
	public static final String WIDGE_NAME = "dsplAccumOfs".toLowerCase();
	private IWidgeType nextWidge = null;

	public DsplAccumOfsWidge(IWidgeType widge) {
