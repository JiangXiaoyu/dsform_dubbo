 ...
 *
 */
public class SumItemWidge implements IWidgeType {

	public String WIDGE_NAME = "sumItem".toLowerCase();

	private IWidgeType widge = null;

	public SumItemWidge(IWidgeType widge) {
		this.widge = widge;
	}
	
	public SumItemWidge(IWidgeType widge,String widgeName) {
		this.widge = widge;
