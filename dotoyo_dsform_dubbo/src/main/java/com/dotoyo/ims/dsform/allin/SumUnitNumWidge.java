 ...
 *
 */
public class SumUnitNumWidge implements IWidgeType {

	public String WIDGE_NAME = "sumUnitNum".toLowerCase();

	private IWidgeType widge = null;

	public SumUnitNumWidge(IWidgeType widge) {
		this.widge = widge;
	}
	
	public SumUnitNumWidge(IWidgeType widge,String widgeName) {
		this.widge = widge;
	...
	public boolean isCurWid(String widgeType){
		if (widgeType.toLowerCase().equalsIgnoreCase(WIDGE_NAME)){
			return true;
		}
		return false;
	}
