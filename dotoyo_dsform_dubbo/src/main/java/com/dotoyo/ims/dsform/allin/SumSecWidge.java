 ...
 *
 */
public class SumSecWidge implements IWidgeType {

	public String WIDGE_NAME = "sumSec".toLowerCase();

	private IWidgeType widge = null;

	public SumSecWidge(IWidgeType widge) {
		this.widge = widge;
	}
	
	public SumSecWidge(IWidgeType widge,String widgeName) {
		this.widge = widge;
