 ...
 *
 */
public class SumUnitWidge implements IWidgeType {

	public String WIDGE_NAME = "sumUnit".toLowerCase();

	private IWidgeType widge = null;

	public SumUnitWidge(IWidgeType widge) {
		this.widge = widge;
	}
	
	public SumUnitWidge(IWidgeType widge,String widgeName) {
		this.widge = widge;
