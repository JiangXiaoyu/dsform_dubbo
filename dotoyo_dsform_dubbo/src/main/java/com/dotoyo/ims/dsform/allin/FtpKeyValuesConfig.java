...
public class FtpKeyValuesConfig {
	protected static final transient IFrameLog log = new LogProxy(
			LogFactory.getLog(FtpKeyValuesConfig.class));

	protected Map<String, Map<String, String>> paramMap = new HashMap<String, Map<String, String>>();

	protected static FtpKeyValuesConfig instance = null;

	protected FtpKeyValuesConfig() throws Exception {
		String xmlPath = "";
		InputStream is = null;
		try {
	...
	public static FtpKeyValuesConfig getInstance() throws Exception {
		if (instance == null) {
			newInstance();
		}
		return instance;
	...
	synchronized private static void newInstance() throws Exception {
		if (instance == null) {
			instance = new FtpKeyValuesConfig();
		}
	}
	...
	public static void main(String[] args) throws Exception {
		Map<String, Map<String, String>> map=	FtpKeyValuesConfig.getInstance().getKeyValues();
		log.debug(map);
	}
