 ...
 *
 */
public class SumPartWidge implements IWidgeType {

	public String WIDGE_NAME = "sumPart".toLowerCase();

	private IWidgeType widge = null;

	public SumPartWidge(IWidgeType widge) {
		this.widge = widge;
	}
	
	public SumPartWidge(IWidgeType widge,String widgeName) {
		this.widge = widge;
